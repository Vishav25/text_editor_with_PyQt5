...
class Main(QMainWindow):
    ...
    def saveFileAs(self):
        pathname= QFileDialog.getSaveFileName(self,'Save file' , 'C:\Documents' , 'Text files(*.txt)')
        filetext =self.textEdit.toPlainText()
    ...
    def openFile(self):
        fname = QFileDialog.getOpenFileName(self,'Open file' , 'C:\Documents' , 'Text files(*.txt)')
